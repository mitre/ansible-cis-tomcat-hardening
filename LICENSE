This repository contains content from the Center for Internet Security (CIS).
...
The validation content created for this InSpec profile is provided under the following terms:
